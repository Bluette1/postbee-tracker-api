...
from webapp.producer import publish_followup_notification  # Adjust the import based on your structure
...
def test_publish_followup_notification():
    ...
    with patch('pika.BlockingConnection') as mock_connection:
        ...
        mock_channel.queue_declare.assert_called_once_with(queue="followup_notifications")
